...
CREATE INDEX `mcp_chart_embed_project_id_idx` ON `mcp_chart_embed` (`project_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `mcp_query_data_project_id_idx` ON `mcp_query_data` (`project_id`);
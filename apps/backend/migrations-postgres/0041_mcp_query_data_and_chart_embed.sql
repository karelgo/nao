...
ALTER TABLE "mcp_chart_embed" ADD CONSTRAINT "mcp_chart_embed_project_id_project_id_fk" FOREIGN KEY ("project_id") REFERENCES "public"."project"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "mcp_chart_embed_project_id_idx" ON "mcp_chart_embed" USING btree ("project_id");--> statement-breakpoint
CREATE INDEX "mcp_query_data_project_id_idx" ON "mcp_query_data" USING btree ("project_id");